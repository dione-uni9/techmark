    ...
    <div class="carousel-item active">
      ...
      <div class="col-md-3" style="float:left">
       <div class="card mb-2">
          ...
          <div class="card-body">
            <h4 class="card-title">Hortifruti</h4>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            <h4 class="card-title">Cereais</h4>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis mollitia molestiae..</p>
            <a href="#"><button class="btn btn-primary">Compre Agora</button></a>
          </div>
        </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            <h4 class="card-title">Padaria</h4>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis mollitia molestiae..</p>
            <a href="#"><button class="btn btn-primary">Compre Agora</button></a>
          </div>
        </div>
    ...
    <div class="carousel-item" id="produtos-abaixo">
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            <h4 class="card-title">Eletrônico</h4>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis mollitia molestiae..</p>
            <a href="#"><button class="btn btn-primary">Compre Agora</button></a>
          </div>
        </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            <h4 class="card-title">Uninove</h4>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis mollitia molestiae..</p>
            <a href="#"><button class="btn btn-primary">Compre Agora</button></a>
          </div>
        </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            <h4 class="card-title">Uni9.edu.br</h4>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis mollitia molestiae..</p>
            <a href="#"><button class="btn btn-primary">Compre Agora</button></a>
          </div>
        </div>
